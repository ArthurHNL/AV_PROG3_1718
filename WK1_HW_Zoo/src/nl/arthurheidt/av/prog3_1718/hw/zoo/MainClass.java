...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		//Animal b = new Frog("Hank"); // -> Allowed, calls the Frog constructor. As Frog extends Animal, a reference
										// variable to a frog can be placed in a Animal-type refrence variable.
		//Animal a;
		//Frog f = new Frog("Joe"); // -> Allowed, calls the frog constructor and constructs a Frog.
